export const state = () => ({
  data: {
    ...
    descriptionHome:"Salon de coiffure pour homme. Soins capillaire ; cheveux et barbe ,Accueil chaleureux et travaille professionnel.",
    adress: {
      title : "Emplacement",
      adress :{
        title: "Adresse postal",
      street :"  Titi lilan . Premiere Boutique à droite En venant de Maâtkas .",
